//Resoluções dos exercícios cap 5 do livro disponível em: https://eloquentjavascript.net/05_higher_order.html
...
function flatten(array){
    let initial = []
    return array.reduce((newArray,current) => newArray.concat(current), initial )
}
