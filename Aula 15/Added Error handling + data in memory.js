...
class Library {
    ...
    addBook(book) {
        try {
            // Verifica se o objeto é uma instância da classe Book
            if (!(book instanceof Book)) {
                // mostra um erro se o objeto não for do tipo Book
            ...
            // Captura e trata o erro, exibe uma mensagem no console
...
const book1 = new Book("Introducao a Programacao Web", "ACDC", 2023);
